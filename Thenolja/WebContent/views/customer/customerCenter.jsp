...
<body>
    ...
    <div id="wrap">
        ...
        <div id="content3" class="content">
            <div class="icon"><div class="iconImg"><a href="<%=contextPath %>/noticeList"><img class="img1" src="../../resources/mypage/bell.png" alt="공지사항"><span>공지사항</span></a></div></div>
            ...
            <div class="icon"><div class="iconImg"><a href="<%=contextPath %>/couponList"><div style="width: 80%;margin: auto;"><img class="img1" src="../../resources/mypage/coupons.png" alt="쿠폰"></div><span>쿠폰</span></a></div></div>
