		...
		<form id="frm" action="<%=contextPath%>/regEvent" method="post">
		   <table class="table-light table-striped text-center" width="100%">
			  <tr>
				 ...
				 <!-- null 값 세팅 방지 -->
				 <% if(event.getEventTitle() == null) event.setEventTitle("");%>
 		  ...
 		  <tr>
            ...
            <td>
            	<% if(!"".equals(event.getEventContent())){ %>
					...
					<div class="array-list" data-attr_item_vlue="null">
						...
						<div class="item">
							<div class="select-box bg-gray" style="float:left; margin-right:10px;">
								<!-- 이벤트 시작일 세팅 -->
								<% if(!"".equals(event.getEventStrtDt())) { %>
									<input type="date" id="eventStrt" class="evnt_inner_inpt" name="eventStrtDt" value="<%=event.getEventStrtDt() %>">
								<% } %>
							</div>
						</div>
						...
						<div class="item">
							<div class="select-box bg-gray" style="float:left; margin-right:10px;">
								<!-- 이벤트 종료일 세팅 -->
								<% if(!"".equals(event.getEventEndDt())) { %>
								<input type="date" id="eventEnd" class="evnt_inner_inpt" name="eventEndDt" value="<%=event.getEventEndDt() %>">
								<% } %>
							</div>
						</div>
